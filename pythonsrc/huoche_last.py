...
ends = "%u82CF%u5DDE%2CSZH"#苏州
#徐州
#ends = "%u5F90%u5DDE%2CXCH"
    ...
    try:
        ...
        if order != 0:
            while b.url == ticket_url:
                ...
                #b.check(b.find_by_name('cc_type').first)
...
#                        print [ i.text for i in b.find_by_text(pa) ]
            ...
            while b.url == ticket_url:
                ...
                b.find_by_text(u"查询").click()
                b.find_by_text(ttype).check()
                #b.find_by_id("checkbox_khf383dTjo").click()
                if b.find_by_text(u"预订"):
                    sleep(0.3)
